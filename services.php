    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="icon-box">
          ...
          <h4 class="title"><a href="">financial Guide</a></h4>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="icon-box">
          ...
          <h4 class="title"><a href="">Financial Calender</a></h4>
      ...
      <div class="col-lg-4 col-md-6" data-wow-delay="0.1s">
        <div class="icon-box">
          ...
          <h4 class="title"><a href="">24/7 Support Care</a></h4>
      ...
      <div class="col-lg-4 col-md-6" data-wow-delay="0.1s">
        <div class="icon-box">
          ...
          <h4 class="title"><a href="">Invoice Reports</a></h4>
      ...
      <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
        <div class="icon-box">
          ...
          <h4 class="title"><a href="">Global Billing Services</a></h4>
      ...
      <div class="col-lg-4 col-md-6" data-wow-delay="0.2s">
        <div class="icon-box">
          ...
          <h4 class="title"><a href="">Quick Billing</a></h4>
